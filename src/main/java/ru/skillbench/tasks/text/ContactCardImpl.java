...
import java.util.Scanner;
    ...
    public class ContactCardImpl implements ContactCard {
         ...
         * @return {@link ContactCard}, созданный из этих данных
         */
        public ContactCard getInstance(String data) {return null; }
         ...
         */
        public boolean isWoman() {return true;}
         ...
         */
        public Calendar getBirthday() {return null;}
         ...
         * @throws NoSuchElementException Если поле BDAY отсутствует в данных
         */
        public Period getAge() {return null;}

        /**
         * @return Возраст человека в годах: например, 74
         * @throws NoSuchElementException Если поле BDAY отсутствует в данных
         */
        public int getAgeYears() {return 0;}
         ...
         */
        public String getPhone(String type) {return null;}
